    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="nasabah.php" class="nav-link active">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <button type="button" class="btn bg-gradient-primary pull-right" data-toggle="modal" data-target="#tambahnb"><li class="fa fa-plus"></li> Tambah Data</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>Nasabah</td>
                    <td><a href="hapus_nasabah.php?id=<?php echo $data['id'];?>"  class="btn btn-danger btn-md btn-del" title="Hapus Data"><i class="fa fa-trash"></i> hapus</a>
                  </tr>
                         <?php 
                         } 
                        ?>
